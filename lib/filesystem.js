  ...
  if(file instanceof File) {
    ...
    return _.extend(this, file, function (destVal, sourceVal) {
      if(_.isObject(sourceVal)) {
        ...
        return _.cloneDeep(sourceVal, function(value) {
...
File.prototype.equals = function(file) {
  return _.isEqual(this, file, function(a, b) {
    if(a instanceof File || b instanceof File) {
      var diff = _.xor(_.keys(a), _.keys(b));

      if(diff.length > 1 || (diff.length === 1 && diff[0] !== 'files')) {
        return false;
      }
      ...
      if((a.files || []).length > 0 || (b.files || []).length > 0) {
        if(!_.isArray(a.files) || !_.isArray(b.files) || a.files.length !== b.files.length) {
          return false;
        }
...
File.prototype.clone = function() {
  //Create a new instance of File copied from this file instance and return it.
  return new File(this);
};

File.prototype.flatten = function() {
